...
export default function Section5(){
    return(
        <div className={roboto.className}>
            ...
            <div className="text-3xl font-bold mb-4   lg:font-extrabold lg:text-6xl lg:mb-20" style={{color:"#rgba(15,23,42,1)"}}>
        What everyone says
            </div>
        <div className="lg:flex ">
        <div className=" border-2 p-8 shadow-lg rounded-lg m-8">
        ...
        <div className=" border-2 p-8 shadow-lg rounded-lg m-8" style={{width:"412"}}>
        <div className="text-sm">
        ...
        <div className="items-center ml-2 flex">
            ...
            <div className="text">
                <div className="text-3xl font-bold my-4 lg:text-6xl lg:font-extrabold lg:my-20">
        All the cool features
                ...
                <a href="#" className="text-sky-700 mt-10 flex gap-2">View all the features
